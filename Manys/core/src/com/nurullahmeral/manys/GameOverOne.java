...
public class GameOverOne implements Screen {
    ...
    public GameOverOne(final CountMoneyGame game5){
        this.game5 = game5;
        batch = new SpriteBatch();
        stage = new Stage(new FitViewport(Gdx.graphics.getWidth(),Gdx.graphics.getHeight()));
        skin = game5.getAssetManager().get("glassy-ui.json");
        gameoverone = game5.getAssetManager().get("gameover.png");
        ...
        label.setPosition(Gdx.graphics.getWidth()*5/12,Gdx.graphics.getHeight()*7/24);
    ...
    public void render(float delta) {
        ...
        yes.addCaptureListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent changeEvent, Actor actor) {
                if (gameoverstate == 1){
                    game5.setScreen(game5.manys);
                }
                if (gameoverstate == 2){
                    game5.setScreen(game5.easyModeScreen);
                }
                if (gameoverstate == 3){
                    game5.setScreen(game5.secondGameScreen);
                }
                if (gameoverstate == 4){
    ...
    public int getGameoverayir() {
        return gameoverayir;
    }

    public void setGameoverayir(int gameoverayir) {
        this.gameoverayir = gameoverayir;
    }
