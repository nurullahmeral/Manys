...
public  class LevelGameFiveteen implements Screen {
    ...
    public LevelGameFiveteen(CountMoneyGame game3,GameOverScreen gameOverScreen,GameOverMission gameOverMission) {
        ...
        if (buttonstate ==2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelfiveteentoplam(gameOverScreen.getLevelfiveteentoplam() + toplam);
                    parasayi = 1;
                    toplam = 0;
                    azaltX = 0;
                    paraX = 0;
                    ...
                    Gdx.gl.glClearColor(0.4f, 0.5f, 0.8f, 1f);
                    Gdx.gl.glClearColor(GL20.GL_COLOR_BUFFER_BIT, GL20.GL_COLOR_BUFFER_BIT, GL20.GL_COLOR_BUFFER_BIT, GL20.GL_COLOR_BUFFER_BIT);
                    gameOverMission.setGameoverstate(18);
