...
public  class SecondGameScreen implements Screen {
    ...
    int a;
    int toplam;
    int kisit,kisittoplam,parasayikisit;
    int parasayi = 1;
    private Label label;
    ...
    public SecondGameScreen(final CountMoneyGame game2,GameOverScreen gameOverScreen,final HighScore highScore) {
        ...
        if (gamestate == 1) {
            ...
            if (Gdx.input.justTouched()) {
              ...
              //  barX = Gdx.graphics.getWidth()/30;
                ...
                gameOverScreen.setTimemodetoplam(gameOverScreen.getTimemodetoplam()+toplam);
