...
public  class LevelGameTwentyfour implements Screen {
    ...
    public LevelGameTwentyfour(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentyfourtoplam(gameOverScreen.getLeveltwentyfourtoplam()+toplam);
