...
public  class LevelGameEigthteen implements Screen {
    ...
    public LevelGameEigthteen(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveleigthteentoplam(gameOverScreen.getLeveleigthteentoplam()+toplam);
