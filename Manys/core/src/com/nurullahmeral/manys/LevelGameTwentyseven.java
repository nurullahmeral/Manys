...
public  class LevelGameTwentyseven implements Screen {
    ...
    public LevelGameTwentyseven(CountMoneyGame game3,GameOverScreen gameOverScreen,GameOverMission gameOverMission) {
        ...
        buttonone = new TextButton("Count 25 money",buttononestyle);
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentyseventoplam(gameOverScreen.getLeveltwentyseventoplam() + toplam);
                    parasayi = 1;
                    toplam = 0;
                    azaltX = 0;
                    paraX = 0;
                    ...
                    gameOverMission.setGameoverstate(30);
