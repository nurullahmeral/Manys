...
public  class LevelGameThirtytwo implements Screen {
    ...
    public LevelGameThirtytwo(CountMoneyGame game3,GameOverScreen gameOverScreen,GameOverMission gameOverMission) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelthirtytwotoplam(gameOverScreen.getLevelthirtytwotoplam() + toplam);
                    parasayi = 1;
                    toplam = 0;
                    azaltX = 0;
                    paraX = 0;
                    ...
                    gameOverMission.setGameoverstate(35);
