...
public  class LevelGameTen implements Screen {
    ...
    public LevelGameTen(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltentoplam(gameOverScreen.getLeveltentoplam()+toplam);
