...
public  class LevelGameFive implements Screen {
    ...
    public LevelGameFive(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate ==2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelfivetoplam(gameOverScreen.getLevelfivetoplam()+toplam);
