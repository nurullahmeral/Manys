...
public  class LevelGameThirty implements Screen {
    ...
    public LevelGameThirty(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelthirtytoplam(gameOverScreen.getLevelthirtytoplam()+toplam);
