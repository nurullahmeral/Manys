...
public class MissionScreenTree implements Screen {
    ...
    public MissionScreenTree(final CountMoneyGame game6, final HighScore highScore) {
        ...
        img = game6.getAssetManager().get("levelarkaplantree.png");
        ...
        level14.addCaptureListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                click.play();
                game6.setScreen(game6.missionScreenTwo);
            }
        });
