...
public  class LevelGameEight implements Screen {
    ...
    public LevelGameEight(CountMoneyGame game3,GameOverScreen gameOverScreen,GameOverMission gameOverMission) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveleigthtoplam(gameOverScreen.getLeveleigthtoplam() + toplam);
                    parasayi = 1;
                    toplam = 0;
                    azaltX = 0;
                    paraX = 0;
                    ...
                    gameOverMission.setGameoverstate(11);
