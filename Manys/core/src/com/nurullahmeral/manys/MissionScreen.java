...
public class MissionScreen implements Screen {
    ...
    public MissionScreen(final CountMoneyGame game6, final HighScore highScore) {
        ...
        img = game6.getAssetManager().get("levelarkaplanone.png");
        ...
        level1 = new TextButton("", level1style);
