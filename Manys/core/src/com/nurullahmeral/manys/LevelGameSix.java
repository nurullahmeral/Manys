...
public  class LevelGameSix implements Screen {
    ...
    public LevelGameSix(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelsixtoplam(gameOverScreen.getLevelsixtoplam()+toplam);
