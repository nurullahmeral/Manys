...
public  class LevelGameTwentyeight implements Screen {
    ...
    public LevelGameTwentyeight(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentyeigthtoplam(gameOverScreen.getLeveltwentyeigthtoplam()+toplam);
