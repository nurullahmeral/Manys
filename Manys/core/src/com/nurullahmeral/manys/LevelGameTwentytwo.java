...
public  class LevelGameTwentytwo implements Screen {
    ...
    public LevelGameTwentytwo(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentytwotoplam(gameOverScreen.getLeveltwentytwotoplam()+toplam);
