...
public  class LevelGameTwentytree implements Screen {
    ...
    public LevelGameTwentytree(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentytreetoplam(gameOverScreen.getLeveltwentytreetoplam()+toplam);
