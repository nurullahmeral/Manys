...
public  class LevelGameTwentynine implements Screen {
    ...
    public LevelGameTwentynine(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentyninetoplam(gameOverScreen.getLeveltwentyninetoplam()+toplam);
