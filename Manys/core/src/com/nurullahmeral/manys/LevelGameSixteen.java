...
public  class LevelGameSixteen implements Screen {
    ...
    public LevelGameSixteen(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelsixteentoplam(gameOverScreen.getLevelsixteentoplam()+toplam);
