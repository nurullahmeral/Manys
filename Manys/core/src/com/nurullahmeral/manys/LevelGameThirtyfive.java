...
public  class LevelGameThirtyfive implements Screen {
    ...
    public LevelGameThirtyfive(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelthirtyfivetoplam(gameOverScreen.getLevelthirtyfivetoplam()+toplam);
