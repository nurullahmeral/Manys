...
public  class LevelGameTwentyfive implements Screen {
    ...
    public LevelGameTwentyfive(CountMoneyGame game3, GameOverScreen gameOverScreen,GameOverMission gameOverMission) {
        ...
        buttonone = new TextButton("Count 15 money",buttononestyle);
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLeveltwentyfivetoplam(gameOverScreen.getLeveltwentyfivetoplam() + toplam);
                    parasayi = 1;
                    toplam = 0;
                    azaltX = 0;
                    paraX = 0;
                    ...
                    gameOverMission.setGameoverstate(28);
