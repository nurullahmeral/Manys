...
public  class LevelGameSeventeen implements Screen {
    ...
    public LevelGameSeventeen(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelseventeentoplam(gameOverScreen.getLevelseventeentoplam()+toplam);
