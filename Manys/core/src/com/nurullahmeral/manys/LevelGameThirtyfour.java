...
public  class LevelGameThirtyfour implements Screen {
    ...
    public LevelGameThirtyfour(final CountMoneyGame game2,GameOverScreen gameOverScreen) {
        ...
        if (buttonstate == 2){
            ...
            if (gamestate == 1) {
                ...
                if (Gdx.input.justTouched()) {
                    ...
                    gameOverScreen.setLevelthirtyfourtoplam(gameOverScreen.getLevelthirtyfourtoplam()+toplam);
